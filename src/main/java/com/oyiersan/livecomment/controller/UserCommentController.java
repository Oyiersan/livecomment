...
public class UserCommentController {
    ...
    public ResponseModel<PageInfo<UserCommentVO>> pageUserComment(@RequestBody PageReqDTO dto) {
        return ResponseModel.success(liveCommentService.pageUserComment(dto));
    }

    @PostMapping("/top")
    @ApiOperation(value = "top榜单")
    public ResponseModel<PageInfo<UserCommentTopVO>> topUserComment(@RequestBody TopUserCommentDTO dto) {
